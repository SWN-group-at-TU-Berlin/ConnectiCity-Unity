...
We just need to click on a subcatchment that is hosting buildings in order to open its metrics window and add a bus stop #cutout:notActive

Great,  let’s figure out the costs and benefits of introducing public transport in the area!#layout:Right #portrait:MobilityPlanner #speaker:Mobility Planner #arrow:deactivate #buttons:enable